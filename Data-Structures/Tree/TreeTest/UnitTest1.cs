...
namespace TreeTest
{
    public class UnitTest1
    {
        ...
        /// <summary>
        /// Validates the Binary Tree depth first transversal using the post-order method
        /// </summary>
        [Fact]
        public void PostOrderValidation()
        {
            ...
            BinaryTree.nodes = new List<Node>();
            BinaryTree.nodes = BinaryTree.PostOrder(top);

            Assert.Equal(6, BinaryTree.nodes.IndexOf(top));
        }
    }
}
